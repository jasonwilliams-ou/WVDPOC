...
#------------------------------------------------------------------------
# 06/02/2021                     1.0        Intial Version - Copied from Dean Cefola
#
#
#*********************************************************************************
#
...
write-host 'AIB Customization: FsLogix Download Complete'
...
write-host 'AIB Customization: FsLogix Installed'
#############
#    END    #
#############
